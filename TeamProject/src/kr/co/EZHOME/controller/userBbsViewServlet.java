...
/**
 * Servlet implementation class userBbsViewServlet
 */
@WebServlet("/userBbsView.do")
public class userBbsViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public userBbsViewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = "/managePage/userBbsView.jsp";
		String file1 = "";
		String file2 = "";
		int count = 0;
