...
public class ItemDAO3 {
	...
	public List<ItemVO3> selectAllItems(int start, int end) {
		...
		try {
			...
			while (rs.next()) {
				...
				iVo3.setItem_main(rs.getString("item_main"));
				iVo3.setItem_sales(rs.getInt("item_sales"));
				iVo3.setItem_discount(rs.getDouble("item_discount"));
				iVo3.setItem_starsAvg(rs.getDouble("item_starsAvg"));
				list.add(iVo3);
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void insertItem(ItemVO3 iVo3) {
		...
		try {
			...
			pstmt.setString(10, iVo3.getItem_main());
		...
		try {
			...
			try {
				...
				if (rs.next()) {
					...
					iVo3.setItem_main(rs.getString(12));
					iVo3.setItem_sales(rs.getInt(13));
					iVo3.setItem_discount(rs.getDouble(14));
					iVo3.setItem_starsAvg(rs.getDouble(15));
				}
			} catch (Exception e) {
				e.printStackTrace();
			} finally {
	...
	public void updateItem(ItemVO3 iVo3) {
		...
		try {
			...
			pstmt.setString(11, iVo3.getItem_main());
			pstmt.setInt(12, iVo3.getItem_sales());
			pstmt.setDouble(13, iVo3.getItem_discount());
			pstmt.setDouble(14, iVo3.getItem_starsAvg());
			pstmt.setInt(15, iVo3.getItem_num());
			pstmt.executeUpdate();
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
