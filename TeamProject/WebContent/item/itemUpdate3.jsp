...
<body>
	<div id="wrap" style="width: 400px" align="center">
		<h1>상품 수정-관리자 페이지</h1>
		<form action="itemUpdate3.do" method="post" enctype="multipart/form-data" name="frm">
			...
			<table>
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:otherwise>
								<img id="imgUpdate" src="upload/${item.item_pictureUrl1}">
							</c:otherwise>
						</c:choose>
					</td>
				</tr>
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:otherwise>
								<img id="imgUpdate" src="upload/${item.item_pictureUrl2}">
							</c:otherwise>
						</c:choose>
					</td>
				</tr>
				...
				<tr>
					<th>상세 사진</th>
					<td>
						<input type="file" name="item_pictureUrl2"><br>
						(주의 사항: 이미지를 바꾸려고 할 때만 선택하세요.)									
					</td>
				</tr>
			</table><br>
