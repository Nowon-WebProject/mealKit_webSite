...
<input type="hidden" name="userid" value="${loginUser.userid}">
	...
	<br>
	<br>
	<div style="color:red">※ 회원 탈퇴 시 이미 결제된 주문은 취소/환불 되지 않으며, 탈퇴 후 관련 정보가 파기되므로, 신중한 탈퇴를 부탁드립니다.
	<br>※ 관련하여 문의 사항이 있으시다면 1대1 문의를 해주세요.</div>
	<br>
	<div id="table" align="center">
	<div align="center"><strong>회원탈퇴 안내</strong>
	<div align="center"><textarea rows="10" cols="100" readonly>[회원탈퇴 약관]
...
<input type="checkbox" id="check1"><i class="bi bi-exclamation-lg" style="color:red"></i>회원 탈퇴 안내에 동의합니다.
	</div>
	...
	<div align="center"><textarea rows="10" cols="100" readonly>
...
제 6 조 개인정보의 안정성 확보조치
 ...
 기술적 조치 : 개인정보에 대한 접근 제한, 중요정보에 대한 암호화, 보안프로그램 설치 등
	...
	<input type="checkbox" id="check2">  <i class="bi bi-exclamation-lg" style="color:red"></i> 개인정보처리방침에 동의합니다.
	</div>
	<br>

	<input type="submit" value="탈퇴하기 " id="next" onclick="location.href='delete.jsp'">
