 ...
 * Generated at: 2022-05-16 12:13:23 UTC
...
String addr2 = addr.substring(addr.lastIndexOf(",")+2);
      ...
      out.write("	      $(\"input:text[name=delitext]\").attr(\"value\",\"\");\r\n");
      out.write("    }else{\r\n");
      ...
      out.write("	    if($(\"input[name=addrCheck]:checked\").val() == \"1\"){\r\n");
      out.write("	      $(\"input:text[name=deli_name]\").attr(\"value\",\"\");\r\n");
      out.write("	      $(\"input:text[name=deli_name]\").attr(\"readonly\",false);	      \r\n");
      out.write("	      $(\"input:text[name=deli_postcode]\").attr(\"value\",\"\");\r\n");
      out.write("	      $(\"input:text[name=deli_postcode]\").attr(\"readonly\",false);	      \r\n");
      out.write("	      $(\"input:text[name=deli_addr1]\").attr(\"value\",\"\");\r\n");
      out.write("	      $(\"input:text[name=deli_addr1]\").attr(\"readonly\",false);	      \r\n");
      out.write("	      $(\"input:text[name=deli_addr2]\").attr(\"value\",\"\");\r\n");
      out.write("	      $(\"input:text[name=deli_addr2]\").attr(\"readonly\",false);	      \r\n");
      out.write("	      $(\"input:text[name=deli_phone]\").attr(\"value\",\"\");\r\n");
      out.write("	      $(\"input:text[name=deli_phone]\").attr(\"readonly\",false);	      \r\n");
      out.write("	    	\r\n");
      out.write("	    }else if($(\"input[name=addrCheck]:checked\").val() == \"0\"){\r\n");
      out.write("	      $(\"input:text[name=deli_name]\").attr(\"value\",\"");
      out.print(session.getAttribute("name"));
      out.write("\");\r\n");
      out.write("	      $(\"input:text[name=deli_name]\").attr(\"readonly\",true);\r\n");
      out.write("	      $(\"input:text[name=deli_postcode]\").attr(\"value\",\"000-000\");\r\n");
      ...
      out.write("    $( '#ab' ).text( ab );\r\n");
      out.write("    $( '#usePointResult' ).text( b );\r\n");
      out.write("    } );\r\n");
      out.write(" \r\n");
      out.write("$( document ).ready( function() {\r\n");
      ...
      out.write("<!-- 주문자 정보  -->\r\n");
      out.write("		</div>\r\n");
      out.write("		<form action=\"payment.jsp\" method=\"post\" name=\"frm\">\r\n");
      ...
      out.write("								<td><input type=\"text\" name=\"deli_name\" readonly\r\n");
      out.write("									value=\"");
      out.print(session.getAttribute("name"));
      out.write("\"></td>\r\n");
      out.write("							</tr>\r\n");
      ...
      out.print(addr1);
      out.write("\" placeholder=\"도로명주소\" readonly><br>\r\n");
      out.write("								<input type=\"text\" name=\"deli_addr2\" id=\"sample4_detailAddress\" value=\"");
      out.print(addr2);
      out.write("\"  placeholder=\"상세주소\" size=\"60\" readonly><br>\r\n");
      ...
      out.write("							<tr>\r\n");
      out.write("								<th>휴대폰 번호</th>\r\n");
      out.write("								<td><input type=\"text\" name=\"deli_phone\" readonly\r\n");
      out.write("									value=\"");
      out.print(session.getAttribute("phone"));
      out.write("\"></td>\r\n");
      out.write("							</tr>\r\n");
      ...
      out.write("\" name=\"usePoint\" value=\"0\" size=\"3\">\r\n");
      out.write("								사용가능한 포인트 : ");
      out.print(session.getAttribute("point"));
      out.write("p<br>\r\n");
      out.write("							</tr>\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /purchase.jsp(187,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("result");
      // /purchase.jsp(187,4) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/purchase.jsp(187,4) '0'",_jsp_getExpressionFactory().createValueExpression("0",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /purchase.jsp(188,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("cart");
      // /purchase.jsp(188,4) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/purchase.jsp(188,4) '${clist}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${clist}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("					<tr>\r\n");
            out.write("						<td><img alt=\"이미지\" src=\"images/product/1.jpg\" width=\"75px\"\r\n");
            out.write("							height=\"75px\"></td>\r\n");
            out.write("						<td>");
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /purchase.jsp(193,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /purchase.jsp(193,10) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /purchase.jsp(196,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /purchase.jsp(199,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f1.setVar("result");
      // /purchase.jsp(199,5) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f1.setValue(new org.apache.jasper.el.JspValueExpression("/purchase.jsp(199,5) '${result+(cart.item_price*cart.item_cnt)}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${result+(cart.item_price*cart.item_cnt)}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /purchase.jsp(294,11) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /purchase.jsp(296,12) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fparseNumber_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /purchase.jsp(298,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fparseNumber_005f0.setVar("point");
      // /purchase.jsp(298,6) name = integerOnly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fparseNumber_005f0.setIntegerOnly(true);
      // /purchase.jsp(298,6) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /purchase.jsp(299,16) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
